...
<div class="main">
    ...
    <div class="categoryName">
        <ul class="galleryMenu">
            <li><a onclick="ringGallery()"><h1>КОЛЬЦА</h1></a></li>
            <li><a onclick="braceletsGallery()"><h1>БРАСЛЕТЫ</h1></a></li>
            <li><a onclick="necklacesGallery()"><h1>ОЖЕРЕЛЬЯ</h1></a></li>
            <li><a onclick="earringGallery()"><h1>СЕРЬГИ</h1></a></li>
        </ul>
    </div>
